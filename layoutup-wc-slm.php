<?php
/**
 * Plugin Name:                 LayoutUP WC SLM
 * Plugin URI:                  https://github.com/ducwp/layoutup-wc-slm
 * Description:                 Seamless integration between Woocommerce and Software License Manager
 * Version:                     2.0.2
 * Author:                      Duc Nguyen - Omid Shamlu
    ...
    class WC_SLM
    {
        ...
        private function includes()
        {
            ...
            if (is_admin()) {
                ...
                require_once WC_SLM_DIR . 'includes/fields.php';
                //require_once WC_SLM_DIR . 'includes/fields_bk.php';
